...
export function clickUI(options: ClickUIPluginOptions = {}): Plugin {
...
function generateCSSFromConfig(config: any): string {
...
function generateVariables(obj: any, prefix: string, path: string[] = []): string {
  let vars = '';
