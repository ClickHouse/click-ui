...
No action needed! The `CardHorizontal` component now automatically protects users when they click info links. All existing cards will benefit from these security improvements without any code changes.
