...
function updateCollectionStatus(inputValue: string) {
  const statusEl = document.getElementById('collectionStatus') as HTMLSpanElement;
...
function populateCollectionsList(collections: CollectionInfo[]) {
  ...
  const datalist = document.getElementById('collectionsList') as HTMLDataListElement;
  datalist.innerHTML = '';
