...
const FeatureHexagonDark = (props: SVGAssetProps) => (
  <svg
    width="64"
    height="64"
    viewBox="0 0 64 64"
  ...
  >
    ...
    <defs>
      ...
      >
        ...
        <feColorMatrix
          type="matrix"
          values="0 0 0 0 0.0823529 0 0 0 0 0.0823529 0 0 0 0 0.0823529 0 0 0 0.6 0"
        />
        <feBlend
          mode="normal"
        ...
        <feBlend
          mode="normal"
          in2="effect1_dropShadow_17_268"
          result="effect2_dropShadow_17_268"
        />
        <feBlend
          mode="normal"
          in="SourceGraphic"
          in2="effect2_dropShadow_17_268"
          result="shape"
        />
      </filter>
      <linearGradient
...
const FeatureHexagon = ({ theme, ...props }: SVGAssetProps) => {
  if (theme === 'dark') {
    return <FeatureHexagonDark {...props} />;
  }

  return <FeatureHexagonLight {...props} />;
};
