...
const DropdownTrigger = (props: DropdownSubTriggerProps | DropdownTriggerProps) => {
  if ("sub" in props) {
    const { sub, children, ...menuProps } = props as DropdownSubTriggerProps;
    return (
      <DropdownMenuItem
  ...
  return <DropdownMenu.Trigger {...(props as DropdownTriggerProps)} />;
};
