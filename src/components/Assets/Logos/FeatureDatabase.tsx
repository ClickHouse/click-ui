...
const FeatureDatabaseLight = (props: SVGAssetProps) => (
  <svg
    width="64"
    height="64"
    viewBox="0 0 64 64"
...
const FeatureDatabase = ({ theme, ...props }: SVGAssetProps) => {
  if (theme === 'dark') {
    return <FeatureDatabaseDark {...props} />;
  }

  return <FeatureDatabaseLight {...props} />;
};
