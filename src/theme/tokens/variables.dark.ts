const theme = {
  'click': {
        ...
        'color': {
          'primary': {
            'background': {
              ...
              'disabled': '#414141',
              'loading': 'linear-gradient(90deg, rgb(206, 211, 84, 0.1) 0%, rgb(206, 211, 84) 100%)'
            },
            'text': {
              'default': '#1f1f1c',
              'hover': '#1f1f1c',
          ...
          'secondary': {
            'background': {
              ...
              'disabled': '#414141',
              'loading': 'linear-gradient(90deg, rgb(48, 48, 43, 0.1) 0%, rgb(48, 48, 43) 100%)'
            },
            'stroke': {
              'default': '#414141',
              'hover': '#53575f',
          ...
          'danger': {
            'background': {
              ...
              'disabled': '#414141',
              'loading': 'linear-gradient(90deg, rgb(93, 45, 42, 0.1) 0%, rgb(93, 45, 42) 100%)'
            },
            'text': {
              'default': '#ffbaba',
              'hover': '#ffbaba',
          ...
          'empty': {
            ...
            'background': {
              ...
              'loading': 'linear-gradient(90deg, rgb(50, 51, 27, 0.1) 0%, rgb(50, 51, 27, 0.5) 100%)'
            },
            'stroke': {
              'default': 'rgba(0, 0, 0, 0)',
              'hover': 'rgba(0, 0, 0, 0)',
    ...
    'card': {
      ...
      'shadow': '0 4px 6px -1px rgb(8.2353% 8.2353% 8.2353% / 0.6), 0 2px 4px -1px rgb(8.2353% 8.2353% 8.2353% / 0.6)',
      'horizontal': {
        'radii': {
          'all': '0.25rem'
        },
    ...
    'dialog': {
      ...
      'shadow': {
        'default': '0 4px 6px -1px rgb(8.2353% 8.2353% 8.2353% / 0.6), 0 2px 4px -1px rgb(8.2353% 8.2353% 8.2353% / 0.6)'
      },
      'stroke': {
    ...
    'dashboards': {
      'chartWidget': {
        ...
        'shadow': {
          'default': '0',
          'hover': '0 4px 6px -1px rgb(8.2353% 8.2353% 8.2353% / 0.6), 0 2px 4px -1px rgb(8.2353% 8.2353% 8.2353% / 0.6)'
        },
        'size': {
          'icon': {
            'all': {
