        ...
        'color': {
          'primary': {
            'background': {
              ...
              'active': '#161517',
              'disabled': '#dfdfdf',
              'loading': 'linear-gradient(90deg, rgb(76, 76, 76, 0.1) 0%, rgb(76, 76, 76) 100%)'
            },
            'stroke': {
              'default': '#302e32',
              'hover': 'lch(29.47 4.1845 266.96)',
          ...
          'secondary': {
            'background': {
              ...
              'disabled': '#dfdfdf',
              'loading': 'linear-gradient(90deg, rgb(232, 233, 235, 0.1) 0%, rgb(232, 233, 235) 100%)'
            },
            'stroke': {
              'default': '#e6e7e9',
              'hover': '#e6e7e9',
          ...
          'danger': {
            ...
            'background': {
              ...
              'disabled': '#dfdfdf',
              'loading': 'linear-gradient(90deg, rgba(255, 211, 211, 0.1) 0%, rgb(255, 211, 211) 100%)'
            },
            'stroke': {
              'default': 'rgb(100% 13.725% 13.725% / 0.1)',
          ...
          'empty': {
            ...
            'background': {
              ...
              'loading': 'linear-gradient(90deg, rgba(240, 242, 248, 0.1) 0%, rgb(240, 242, 248) 100%)'
            },
            'stroke': {
              'default': 'rgba(0, 0, 0, 0)',
              'hover': 'rgba(0, 0, 0, 0)',
